...
Four new CLI entry points for extraction and validation:
...
**Validation:**
```bash
# Validate single experiment against CMIP6/RECCAP2
utils-cmip7-validate-experiment xqhuc --use-default-soil-params

# Generate PPE validation report
utils-cmip7-validate-ppe xqhuc --top-n 20 --param-viz
```
...
- Soil parameter support (file, log parsing, manual, default)
- PPE ensemble visualization and ranking
- Parameter importance analysis
- Comprehensive help documentation

**Implementation:**
- New module: `src/utils_cmip7/cli.py`
- Four entry points registered in `pyproject.toml`
...
### New Files Created (8)
1. `src/utils_cmip7/cli.py` - CLI implementation (4 entry points)
...
3. `pyproject.toml` - Registered 4 CLI entry points
4. `docs/API_REFERENCE.md` - Added CLI and plotting documentation
5. `docs/MIGRATION_GUIDE.md` - Added CLI examples
...
1. **CLI Commands:**
   ...
   # Test extraction
   utils-cmip7-extract-preprocessed xqhuc --output test.csv

   # Test validation (requires data)
   utils-cmip7-validate-experiment xqhuc --use-default-soil-params
   utils-cmip7-validate-ppe xqhuc --top-n 10
   ```
